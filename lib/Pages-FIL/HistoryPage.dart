...
class _HistoryPageState extends State<HistoryPage> {
  ...
  void _showDetail(BuildContext context, String? imagePath, String analysis, int index) {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: const Text('Detalye ng Larawan'),
          content: SingleChildScrollView(
            child: Column(
              children: [
                ...
                Text(
                  'Pagsusuri: $analysis',  // Show full analysis
  ...
  void _confirmDelete(BuildContext context, int index) {
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: const Text('Tanggalin ang Larawan'),
          content: const Text('Tanggalin ang Larawan?'),
          actions: <Widget>[
            TextButton(
                ...
                child: ListTile(
                  ...
                  subtitle: Column(
                    children: [
                      ...
                      Text(
                        'Pagsusuri: $shortAnalysis', // Show short analysis in the list
